...
inline OutputClass horrible_cast(const InputClass input)
{
	...
	[[maybe_unused]] typedef int ERROR_CantUseHorrible_cast[sizeof(InputClass) == sizeof(u) && sizeof(InputClass) == sizeof(OutputClass) ? 1 : -1];
	u.in = input;
	return u.out;
}
...
struct SimplifyMemFunc
{
										...
										GenericMemFuncType &bound_func)
	{
		...
		[[maybe_unused]] typedef char ERROR_Unsupported_member_function_pointer_on_this_compiler[N - 100];
		return 0;
	}
};
...
public:
							   ...
							   StaticFuncPtr function_to_bind)
	{
		...
		[[maybe_unused]] typedef int ERROR_CantUseEvilMethod[sizeof(GenericClass *) == sizeof(function_to_bind) ? 1 : -1];
	...
	inline UnvoidStaticFuncPtr GetStaticFunction() const
	{
		...
		// and data pointers have different sizes.
		// If you get this error, you need to #undef FASTDELEGATE_USESTATICFUNCTIONHACK.
		[[maybe_unused]] typedef int ERROR_CantUseEvilMethod[sizeof(UnvoidStaticFuncPtr) == sizeof(this) ? 1 : -1];
